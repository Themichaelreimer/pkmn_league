...
<tileset name="Grand Town1" tilewidth="16" tileheight="16" tilecount="256" columns="16">
 <image source="Images/Set_E_Grand_Town1.png" trans="ff01fe" width="256" height="256"/>
 <terraintypes>
